...
ORDERER_ADMIN_TLS_SIGN_CERT=${PWD}/organizations/ordererOrganizations/supplychain.com/orderers/orderer.supplychain.com/tls/server.crt
...
#   elif [ $USING_ORG -eq 2 ]; then
#     export CORE_PEER_ADDRESS=peer0.manorg2.supplychain.com:9051
#   elif [ $USING_ORG -eq 3 ]; then
