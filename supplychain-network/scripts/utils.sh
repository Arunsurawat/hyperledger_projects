...
function printHelp() {
  ...
  if [ "$USAGE" == "up" ]; then
    ...
    println "    -c <channel name> - Name of channel to create (defaults to \"supplychainchannel\")"
    ...
    println
    println " Examples:"
    println "   network.sh up createChannel -ca -c supplychainchannel -s couchdb -i 2.0.0"
